...
use crate::messages::ws_messages::{CreateRoom, Connect, Disconnect, RoomIsEmpty, GetUser, NewRoom, AddContactToUser, AddContactActor, GetUserChats,};
...
impl Handler<GetUserChats> for ChatState {
    ...
    fn handle(&mut self, _: GetUserChats, _: &mut Self::Context) -> Self::Result {
